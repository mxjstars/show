...
function(a) {
    ...
    f.addComponent("4", function(a) {
        ...
        return b.id = a.id,
        b.setAttribute("ctype", a.type),
        b.setAttribute("class", "element comp_image editable-image test"),
...
function(window, $) {
    ...
    function getRequestUrl() {
        var a;
        return preview ? (a = isNewPreviewLocation ? PREFIX_URL + "scene_preview.do?t=preview&id=" + sceneId + "&preview=preview" + ".data" : PREFIX_URL + "scene_preview.do?t=preview&id=" + sceneId + "&preview=preview",
        branchid && (a += (/\?/.test(a) ? "&" : "?") + "user=" + branchid)) : a = mobileview ? PREFIX_URL + "scene_preview.do?t=preview&id=" + sceneId : window.scene && window.scene.id ? window.isCheck ? PREFIX_SERVER_HOST + "m/eqs/view/page/" + window.scene.id : PREFIX_S1_URL + "scene_preview.do?t=preview&id=" + window.scene.id : PREFIX_URL + "scene_preview.do?t=preview&id=" + sceneId,
    ...
    !mobilecheck()) {
        var getBg = function() {
            $.ajax({
                ...
                a ? $("body").css("backgroundImage", "url(" + a + ")") : $("body").css("backgroundImage", "url(/show/web/senceCreate/view/images/previewbg_spring.jpg)")
            }, function() {
                $("body").css("backgroundImage", "url(/show/web/senceCreate/view/images/previewbg_spring.jpg)")
            })
        }
          , 
