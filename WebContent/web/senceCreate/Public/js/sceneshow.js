...
! function($) {
    ...
    function addElmentsForPc(a) {
        ...
        c.href = CLIENT_CDN + "pcviewer.css", c.rel = "stylesheet", b.appendChild(c), window != window.top ? $("body").css("background-image", "none") : ($.getScript(CLIENT_CDN + "qrcode.js", function() {
            $.getScript(CLIENT_CDN + "jquery.qrcode.js", function() {
                $("#con").before('<div id="code"><div>扫一扫，分享给朋友！</div><div style="text-align: center;background:#fff;padding: 10px;" id="codeImg"/><div id="view_share" class="bdsharebuttonbox"><a href="#" class="bds_more" data-cmd="more"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a href="#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a><a href="#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a><a href="#" class="bds_sqq" data-cmd="sqq" title="分享到QQ好友"></a><a href="#" class="bds_douban" data-cmd="douban" title="分享到豆瓣网"></a></div><div id="support">技术支持 BY <a target="_blank" href="http://www.48ym.com"></a></div></div>'), $("#codeImg").qrcode({
                    render: "canvas",
                    width: 200,
                    height: 200,
    ...
    function parseJson(a) {
        ...
        var b = a.list,
            ...
            d = !1,
            e = a.obj.image;
        if (b.length <= 0) return alert("此场景不存在"), void(window.location.href = "http://www.48ym.com");
        customLastPage = !1, appendLastPage(a, b), bindShare(a), document.title = a.obj.name, $("#metaDescription").attr("content", a.obj.name + ", " + a.obj.description + ", 由雷锋站长免费移动场景应用自营销管家提供技术支持"), $(".scene_title").html(a.obj.name);
